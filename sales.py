...
class salesClass:
    def __init__(self, root):
        ...
        # ========== Title ===========
        lbl_title = Label(self.root, text="View Customer Bill", font=("goudy old style", 30),
        ...
        btn_clear = Button(self.root, text="Clear",command=self.clear, font=("times new roman", 15, "bold"),
                           bg="lightgray", fg="black", cursor="hand2")  # Fixed text color
        ...
        lbl_list_title = Label(sales_Frame, text="Bill List", font=("goudy old style", 20), bg="#184AA4", fg="white")
        lbl_list_title.pack(side=TOP, fill=X)
    ...
    def show(self):
        ...
        #print(os.listdir('../inventory app')) bill1.txt,catgory.py
    ...
    def search(self):
        if self.var_invoice.get()=="":
            ...
            if self.var_invoice.get().strip() in self.bill_list:
