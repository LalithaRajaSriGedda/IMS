...
class IMS:
    def __init__(self,root):
        ...
        btn_suppiler=Button(LeftMenu,text="Suppiler",command=self.supplier,image=self.icon_side,compound=LEFT,padx=5,anchor='w',font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        ...
        #==footer==========
        lbl_footer= Label(self.root, text="IMS-Inventory Management System\nFor any technical issue contact:123456789",font=("times new roman", 12), bg="#4d636d", fg="white").pack(side=BOTTOM,fill=X)
        self.update_content()
